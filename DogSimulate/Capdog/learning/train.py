...
RL Training Process for Little Dog
"""
import gym
import numpy as np
...
def train(config):
    ...
    with wandb.init(project="SACD_littledog", name=config.run_name, config=config):
        ...
        for i in range(1, config.episodes+1):
            ...
            if i % config.save_every == 0:
                save(config, save_name="SACD_littledog", model=agent.actor_local, wandb=wandb, ep=0)
